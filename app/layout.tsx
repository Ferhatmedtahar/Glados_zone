...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={` ${discord_font.variable} antialiased selection:bg-[var(--foreground)] selection:text-[var(--background)]`}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
...
//       <body
//         //
//         className={` ${AmiriArabic.className} ${discord_font.className} antialiased selection:bg-[var(--foreground)] selection:text-[var(--background)]  `}
//       >
//         <ThemeProvider
//           attribute="class"
//           defaultTheme="system"
